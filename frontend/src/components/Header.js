        ...
        <div className="header">
          <div className="container">
            ...
            <div className="pc-header">
              <div className="row">
                <div className="col-md-3 col-4 d-flex align-items-center logo-v">
                  <Link className="navbar-brand" to="/">
                    <img alt="logo" src="/images/logo.png" />
                  </Link>
                </div>
                ...
                <div className="col-md-3 d-flex align-items-center justify-content-end Login-Register  header-side-v">
                  {userInfo ? (
                    <div className="btn-group">
                      <button
                        type="button"
